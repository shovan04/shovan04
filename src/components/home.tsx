  ...
  return (
    <>
      <div className="h-full">
        <div className="my-6 flex lg:justify-between flex-col-reverse items-center lg:flex-row">
          <div className="max-w-lg my-6">
            <div className="text-gray-300 text-sm lg:text-[18px]">
              Student & Programmer.
            </div>
            ...
            <div className="lg:text-sm text-gray-300 text-[12px] text-justify">
            ...
            <div className="font-CaskaydiaSemiBold flex flex-row items-center  ">
              ...
              <div className="mx-6 flex flex-row">
                ...
                <SocialIcon
                  tooltip="Twitter | X"
                  title="Twitter | X"
                  socialUrl="https://x.com/shovan_04"
                >
                  <svg
                    className="fill-current w-5 h-5"
                    fill=""
          ...
          <div className="lg:w-[23rem] lg:h-[23rem] w-[20rem] h-[20rem] flex my-2 justify-center items-center rounded-full overflow-hidden rotating-border-container cursor-pointer">
            <img
